...
public class Main : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        LogicalLED led3 = new LogicalLED("LED1", 0, 300, led);
        LogicalLED led4 = new LogicalLED("LED2", -100, 300, led);
        ...
        led3.AddSource(not2);
        led4.AddSource(tg);
        LogicalLED led5 = new LogicalLED("LED2", 500, 300, led);
        ...
        LogicalButton bt2 = new LogicalButton("bouton2", 500, 100);
